...
<div class="navbar navbar-inverse navbar-fixed-top headroom" >
    ...
    <div class="container">
       ...
       <?php if (isset($_SESSION['profesor']) && $_SESSION['profesor'] == 1): ?>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <p><a class="btn btn-danger" href="formulario_insertar_usuarios.html">Alta usuarios</a></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <p><a class="btn btn-danger" href="prueba_mostrar_mensajes.php">Ver mensajes</a></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
