						...
						<div class="panel-body">
                            ...
                            <form class="col-6" method="post" action="enviar_mensaje.php">
                                ...
                                while ($filaGrupo = $resultadoGrupos->fetch_assoc()) {
                                    echo "<label><input type='checkbox' class='form-check' name='grupos_destino[]' value='{$filaGrupo['id_grupo']}'><span style='margin-right: 5px;'>{$filaGrupo['nombre_grupo']}</span></label><br>";
                                }
